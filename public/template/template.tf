...
output "VM-ip" {
  value = "${openstack_compute_instance_v2.cpns.network.0.fixed_ip_v4},${openstack_compute_instance_v2.cpns.network.1.fixed_ip_v4}"
}

output "VM-securitygroup" {
  value = "${openstack_compute_instance_v2.cpns.security_groups.4129694193}"
}
...
output "User-MailID" {
  value = "${openstack_compute_instance_v2.cpns.metadata.key}"
}